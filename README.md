...
[中文版](./README_ZH_CN.md) | [Python version](./README.py.md)

An OpenAI-compatible proxy server that sits between your client and an upstream LLM API (default: SiliconFlow). This is the **Rust implementation** — a compiled, high-performance alternative to the [Python version](./README.py.md).
